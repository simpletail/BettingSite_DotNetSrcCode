using Common;
using DimFrontGroup.Providers;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;
using Services.DimFrontGroup;
using System;
using System.IO;
using System.Linq;
using System.Net;
...
namespace DimFrontGroup.AutherizationAtteributes
{
            ...
            if (body != "")
            {
                try
                {
                    ...
                    if (!CheckWords(json))
                    {
                        ...
                        var _frontservice = requestScope.GetService(typeof(IDimFrontGroupService)) as IDimFrontGroupService;
