...
namespace ELog
{
    public class ErrorLog
    {
        ...
        public static void Logwa(String ex, String req)
        {
            var par = "ex=" + ex + "&req=" + req;
            Task.Factory.StartNew(() => HttpHelper.PostLog(ConfigItems.Logurlwa + ApiEndpoint.log, par, "application/x-www-form-urlencoded", "POST"));
        }
