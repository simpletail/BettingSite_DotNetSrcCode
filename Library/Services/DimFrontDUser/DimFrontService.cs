...
namespace Services.DimFrontDUser
{
    public class DimFrontService : IDimFrontService
    {
        ...
        public DataSet Framelogin(Framelogin framelogin)
        {
            ...
            DataSet ds = _sqlClientService.Execute("checkFramelogin", ConfigItems.Conn_AccD, parameters);
            WriteLogAll("Framelogin", JsonConvert.SerializeObject(framelogin) + "Res:" + JsonConvert.SerializeObject(ds));
            return ds;
        }
        ...
        public DataSet ButtonList(Int32 uid)
        {
            try
            {
                ...
                DataSet ds= _sqlClientService.Execute("update_Userbutton", ConfigItems.Conn_AccD, parameters);
                WriteLogAll("ButtonList", JsonConvert.SerializeObject(uid) + "Res:" + JsonConvert.SerializeObject(ds));
                return ds;
            }
            catch (Exception)
            {
        ...
        public DataSet Matchdtlbet(Matchdtlbet matchdtlbet)
        {
            try
            {
                ...
                if (matchdtlbet.gtype == 1)
                {
                    ...
                    DataSet ds= _sqlClientService.Execute("Front_ReportCurrentBet", ConfigItems.Conn_Bet, parameters);
                    WriteLogAll("Matchdtlbet", JsonConvert.SerializeObject(matchdtlbet) + "Res:" + JsonConvert.SerializeObject(ds));
                    return ds;
                }
                else
                {
                    parameters.Add(new SqlParameter() { ParameterName = "Statement", Value = "casinobet" });
                    DataSet ds = _sqlClientService.Execute("front_reportcurrentbet", ConfigItems.Conn_Casino, parameters);
                    WriteLogAll("Matchdtlbet", JsonConvert.SerializeObject(matchdtlbet) + "Res:" + JsonConvert.SerializeObject(ds));
                    return ds;
                }
            }
        ...
        public DataSet Matchdtlbetodds(String gmid)
        {
            try
            {
                ...
                DataSet ds = _sqlClientService.Execute("Demo_GetGamedata", ConfigItems.Conn_Odds, parameters);
                WriteLogAll("Matchdtlbetodds+Demo_GetGamedata", gmid.ToString() + "Res:" + JsonConvert.SerializeObject(ds));
                return ds;
            }
            catch (Exception)
            {
        ...
        public DataSet MarketAnalysisReportodds(String gmid)
        {
            try
            {
                ...
                DataSet ds = _sqlClientService.Execute("Demo_GetGamedata", ConfigItems.Conn_Odds, parameters);
                WriteLogAll("MarketAnalysis+Demo_GetGamedata", gmid.ToString() + "Res:" + JsonConvert.SerializeObject(ds));
                return ds;
            }
            catch (Exception)
            {
        ...
        public DataSet Usercreate()
        {
            try
            {
                ...
                DataSet ds = new DataSet();
                var parameters = new List<SqlParameter>();
                parameters.Add(new SqlParameter() { ParameterName = "Statement", Value = "Below3rd" });
                ds = _sqlClientService.Execute("InsertUsermaster", ConfigItems.Conn_AccD, parameters);
                WriteLogAll("Usercreate+InsertUsermaster/Below3rd",  JsonConvert.SerializeObject(ds));
                return ds;
            }
            catch (Exception ex)
            {
        ...
        public DataSet GetRules(GetRules vt)
        {
            ...
            DataSet ds = _sqlClientService.Execute("Insert_Rules", ConfigItems.Conn_Casinogroup, parameters);
