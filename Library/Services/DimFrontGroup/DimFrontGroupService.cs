    ...
    public class DimFrontGroupService : IDimFrontGroupService
    {
        ...
        public DataSet GetCasinoTabList(CasinoTabs ct)
        {
            try
            {
                ...
                DataSet ds = _sqlClientService.Execute("sp_casinodata", ConfigItems.Conn_CasinoMgroup, parameters);
        ...
        public DataSet OtherCasino(OtherCasino otherCasino)
        {
            try
            {
                ...
                return _sqlClientService.Execute("sp_casinodata", ConfigItems.Conn_CasinoMgroup, parameters);
            }
            catch (Exception)
            {
                throw;
        ...
        public DataSet GetTPCSUserMster(TPCSUserMaster objtpcsum)
        {
            try
            {
                ...
                return _sqlClientService.Execute("usermaster", ConfigItems.Conn_CasinoMgroup, parameters);
            }
            catch (Exception)
            {
                throw;
        ...
        public DataSet TPcurrentbets(TPcurrentbets pcurrentbets)
        {
            try
            {
                var parameters = new List<SqlParameter>();
        ...
        public DataSet LoginTP(LoginTP ltp)
        {
            try
            {
                ...
                ds = _sqlClientService.Execute("casino_master", ConfigItems.Conn_CasinoMgroup, parameters);
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)// && ds.Tables[0].Rows[0]["id"].ToString() == "1"
                {
                    var parameters1 = new List<SqlParameter>();
                    ...
                    ds1 = _sqlClientService.Execute("casino_master", ConfigItems.Conn_CasinoMgroup, parameters1);
