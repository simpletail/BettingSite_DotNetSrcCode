...
namespace Services.DimFront
{
    public interface IDimFrontService
    {
        ...
        DataSet TPcurrentbetsfinal(TPcurrentbets pcurrentbets);
        ...
        DataSet Sportbooklist(TPTest tt);
        DataSet MPaymenttype(Int64 uid);
        DataSet MgetuPaytype(MgetuPaytype mgetuPaytype);
        DataSet Uaddpayment(Uaddpayment mgetuPaytype);
        DataSet MPaymentRpt(MPaymentRpt mgetuPaytype);
    }
}
